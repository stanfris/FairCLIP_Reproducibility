...
PERF_FILE=${MODEL_ARCH}_FAIRFACE__CLIP.csv

python3 finetune_CLIP_fairface_multiclass.py # \
		# --dataset_dir ${DATASET_DIR} \
		# --result_dir ${RESULT_DIR}/CLIP2_${MODEL_ARCH} \
		# --lr ${LR} \
